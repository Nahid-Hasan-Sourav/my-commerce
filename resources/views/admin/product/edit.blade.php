...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Edit Product From</h4>
            ...
            <form class="form-horizontal p-t-20" action="{{ route('product.update',['id'=>$product->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="sub_category_id" id="sub_category_id">
                        ...
                        <option value="{{ $subCategory->id }}" {{ $subCategory->category_id==$product->category_id ? 'selected' : '' }} >{{ $category->name }}</option>
                        @endforeach
                      </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="unit_id">
                        ...
                        <option value="{{ $unit->id }}" {{ $product->unit_id ? 'selected' : '' }}>{{ $unit->name }}</option>
                       @endforeach
                      </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="product_name" id="exampleInputuname3" placeholder="Product Name" value="{{ $product->name }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="product_code" id="exampleInputuname3" placeholder="Product Code" value="{{ $product->code }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="product_model" id="exampleInputuname3" placeholder="Model" value="{{ $product->model }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="stock_amount" id="exampleInputuname3" placeholder="Product Stock Amount" value="{{ $product->stock_amount }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="regular_price" id="exampleInputuname3" placeholder="Regular Price" value="{{ $product->regular_price }}">
                            <input type="number" class="form-control" name="selling_price" id="exampleInputuname3" placeholder="Selling Price" value="{{ $product->selling_price }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" class="form-control summernote" name="long_description" placeholder="Long description">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <img src="{{asset($product->image) }}" width="200" height="100"/>                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="me-3">
                            <input type="radio" name="status" value="1" class="me-1" {{ $product->status == 1 ? 'checked' : '' }}>Published
                        </label>
                        <label class="">
                            <input type="radio" name="status" value="2" class="me-1" {{ $product->status == 2 ? 'checked' : '' }}>UnPublished
                        </label>
                    </div>
                </div>
                <div class="form-group row m-b-0">
                    <div class="offset-sm-3 col-sm-9">
                        <button type="submit" class="mt-4 text-white btn btn-success waves-effect waves-light">Update Product</button>
                    </div>
                </div>
            </form>
