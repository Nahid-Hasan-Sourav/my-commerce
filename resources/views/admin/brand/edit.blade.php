        ...
        <div class="card-body">
            ...
            <form class="form-horizontal p-t-20" action="{{ route('brand.update',['id'=>$brand->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" class="form-control" name="description" placeholder="Brand description">
                            {{ $brand->description }}
                        </textarea>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <img src="{{ asset($brand->image) }}" alt="update-image" width="50px" height="50px">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="me-3">
                            <input type="radio" name="status" value="1" class="me-1" {{ $brand->status == 1  ? 'checked' : '' }}>Published
                        </label>
                        <label class="">
                            <input type="radio" name="status" value="2" class="me-1"  {{ $brand->status == 2 ? 'checked' : '' }}>UnPublished
                        </label>
                    </div>
                </div>
                <div class="form-group row m-b-0">
                    <div class="offset-sm-3 col-sm-9">
                        <button type="submit" class="mt-4 text-white btn btn-success waves-effect waves-light">Update Brand</button>
                    </div>
                </div>
            </form>
