...
<body class="skin-blue fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            {{date('Y-m-d')}} Developed by <span class="fw-bold text-primary">sourav</span>
